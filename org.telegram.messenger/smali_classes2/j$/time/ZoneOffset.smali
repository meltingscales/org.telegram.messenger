...
.method public static h(Ljava/lang/String;)Lj$/time/ZoneOffset;
    ...
    invoke-static {p0, v2, v3}, Lj$/time/ZoneOffset;->k(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v2}, Lj$/time/ZoneOffset;->k(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v5, v2}, Lj$/time/ZoneOffset;->k(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v1, v3}, Lj$/time/ZoneOffset;->k(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v4, v3}, Lj$/time/ZoneOffset;->k(Ljava/lang/CharSequence;IZ)I
    ...
    :cond_9
    invoke-static {v0, v1, v2}, Lj$/time/ZoneOffset;->i(III)Lj$/time/ZoneOffset;
...
.method public static j(I)Lj$/time/ZoneOffset;
    ...
    sget-object p0, Lj$/time/ZoneOffset;->e:Ljava/util/concurrent/ConcurrentMap;
...
.method private static k(Ljava/lang/CharSequence;IZ)I
    .locals 2
...
.method public getRules()Lj$/time/zone/ZoneRules;
    ...
    invoke-static {p0}, Lj$/time/zone/ZoneRules;->e(Lj$/time/ZoneOffset;)Lj$/time/zone/ZoneRules;
