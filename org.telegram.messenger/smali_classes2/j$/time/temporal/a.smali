...
.method static constructor <clinit>()V
    ...
    invoke-static {v14, v15, v12, v13}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-direct/range {v0 .. v6}, Lj$/time/temporal/a;-><init>(Ljava/lang/String;ILjava/lang/String;Lj$/time/temporal/v;Lj$/time/temporal/v;Lj$/time/temporal/x;)V
    ...
    invoke-static {v14, v15, v0, v1}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-static {v14, v15, v5, v6}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-direct/range {v9 .. v16}, Lj$/time/temporal/a;-><init>(Ljava/lang/String;ILjava/lang/String;Lj$/time/temporal/v;Lj$/time/temporal/v;Lj$/time/temporal/x;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, v10, v11}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-static {v14, v15, v11, v12}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-direct/range {v19 .. v26}, Lj$/time/temporal/a;-><init>(Ljava/lang/String;ILjava/lang/String;Lj$/time/temporal/v;Lj$/time/temporal/v;Lj$/time/temporal/x;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v3, v4}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-static {v5, v6, v0, v1}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-static {v0, v1, v14, v15}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
    ...
    invoke-static {v2, v3, v0, v1}, Lj$/time/temporal/x;->i(JJ)Lj$/time/temporal/x;
...
.method private constructor <init>(Ljava/lang/String;ILjava/lang/String;Lj$/time/temporal/v;Lj$/time/temporal/v;Lj$/time/temporal/x;)V
    .locals 0
    ...
    iput-object p6, p0, Lj$/time/temporal/a;->b:Lj$/time/temporal/x;

    return-void
.end method

.method private constructor <init>(Ljava/lang/String;ILjava/lang/String;Lj$/time/temporal/v;Lj$/time/temporal/v;Lj$/time/temporal/x;Ljava/lang/String;)V
    .locals 0
...
.method public a()Lj$/time/temporal/x;
    ...
    iget-object v0, p0, Lj$/time/temporal/a;->b:Lj$/time/temporal/x;
...
.method public d(Lj$/time/temporal/k;)Z
    ...
    invoke-interface {p1, p0}, Lj$/time/temporal/k;->e(Lj$/time/temporal/l;)Z
...
.method public e(Lj$/time/temporal/k;)Lj$/time/temporal/x;
    ...
    invoke-interface {p1, p0}, Lj$/time/temporal/k;->b(Lj$/time/temporal/l;)Lj$/time/temporal/x;
...
.method public g(J)I
    ...
    .line 2
    invoke-virtual {v0, p1, p2, p0}, Lj$/time/temporal/x;->a(JLj$/time/temporal/l;)I
...
.method public h(J)J
    ...
    .line 2
    invoke-virtual {v0, p1, p2, p0}, Lj$/time/temporal/x;->b(JLj$/time/temporal/l;)J
