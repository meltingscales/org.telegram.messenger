...
.method constructor <init>(Ljava/lang/String;ILj$/time/temporal/j;)V
    .locals 0
...
.method static synthetic i(Lj$/time/f;)Lj$/time/temporal/x;
    .locals 0

    invoke-static {p0}, Lj$/time/temporal/g;->m(Lj$/time/f;)Lj$/time/temporal/x;
...
.method static j(Lj$/time/f;)I
    ...
    invoke-virtual {p0, v0}, Lj$/time/f;->r(I)Lj$/time/f;
    ...
    .line 2
    invoke-virtual {p0, v0, v1}, Lj$/time/f;->p(J)Lj$/time/f;
    ...
    invoke-virtual {p0}, Lj$/time/temporal/x;->d()J
...
.method static synthetic k(Lj$/time/f;)I
    .locals 0

    invoke-static {p0}, Lj$/time/temporal/g;->l(Lj$/time/f;)I
...
.method private static l(Lj$/time/f;)I
    .locals 4
...
.method private static m(Lj$/time/f;)Lj$/time/temporal/x;
    .locals 4
    ...
    .line 1
    invoke-static {p0, v0, v0}, Lj$/time/f;->n(III)Lj$/time/f;
...
.method public e(Lj$/time/temporal/k;)Lj$/time/temporal/x;
    ...
    invoke-interface {p0}, Lj$/time/temporal/l;->a()Lj$/time/temporal/x;
