...
.method public static f(Ljava/lang/String;Lj$/time/ZoneOffset;)Lj$/time/ZoneId;
    ...
    .line 3
    invoke-static {p1}, Lj$/time/zone/ZoneRules;->e(Lj$/time/ZoneOffset;)Lj$/time/zone/ZoneRules;

    move-result-object p1

    .line 4
    invoke-direct {v0, p0, p1}, Lj$/time/m;-><init>(Ljava/lang/String;Lj$/time/zone/ZoneRules;)V

    return-object v0
.end method

.method private static g(Ljava/lang/String;IZ)Lj$/time/ZoneId;
    .locals 3
    ...
    sget-object p0, Lj$/time/ZoneOffset;->f:Lj$/time/ZoneOffset;
    ...
    invoke-static {p0, p2}, Lj$/time/m;->h(Ljava/lang/String;Z)Lj$/time/m;
    ...
    invoke-static {p1}, Lj$/time/ZoneOffset;->h(Ljava/lang/String;)Lj$/time/ZoneOffset;

    move-result-object p1

    sget-object p2, Lj$/time/ZoneOffset;->f:Lj$/time/ZoneOffset;
...
.method public static of(Ljava/lang/String;)Lj$/time/ZoneId;
    ...
    :cond_2
    invoke-static {p0, v1}, Lj$/time/m;->h(Ljava/lang/String;Z)Lj$/time/m;
    ...
    :goto_1
    invoke-static {p0, v0, v1}, Lj$/time/ZoneId;->g(Ljava/lang/String;IZ)Lj$/time/ZoneId;
    ...
    :cond_4
    :goto_2
    invoke-static {p0}, Lj$/time/ZoneOffset;->h(Ljava/lang/String;)Lj$/time/ZoneOffset;
...
.method public getDisplayName(Lj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lj$/time/format/r;->o(Lj$/time/format/TextStyle;)Lj$/time/format/r;
    ...
    invoke-direct {p2, p0}, Lj$/time/l;-><init>(Lj$/time/ZoneId;)V

    .line 2
    invoke-virtual {p1, p2}, Lj$/time/format/a;->a(Lj$/time/temporal/k;)Ljava/lang/String;
