...
.method public doubles()Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v9, v0}, Lj$/util/stream/o1;->r(Lj$/util/t$a;Z)Lj$/util/stream/U;
...
.method public doubles(DD)Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v0, p1}, Lj$/util/stream/o1;->r(Lj$/util/t$a;Z)Lj$/util/stream/U;
...
.method public doubles(JDD)Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v0, v1}, Lj$/util/stream/o1;->r(Lj$/util/t$a;Z)Lj$/util/stream/U;
...
.method public ints()Ljava/util/stream/IntStream;
    ...
    invoke-static {v7, v0}, Lj$/util/stream/o1;->s(Lj$/util/t$b;Z)Lj$/util/stream/IntStream;
...
.method public ints(II)Ljava/util/stream/IntStream;
    ...
    invoke-static {v7, p1}, Lj$/util/stream/o1;->s(Lj$/util/t$b;Z)Lj$/util/stream/IntStream;
...
.method public ints(J)Ljava/util/stream/IntStream;
    ...
    invoke-static {v0, p1}, Lj$/util/stream/o1;->s(Lj$/util/t$b;Z)Lj$/util/stream/IntStream;
...
.method public longs()Ljava/util/stream/LongStream;
    ...
    invoke-static {v9, v0}, Lj$/util/stream/o1;->t(Lj$/util/t$c;Z)Lj$/util/stream/e1;
...
.method public longs(J)Ljava/util/stream/LongStream;
    ...
    invoke-static {v0, p1}, Lj$/util/stream/o1;->t(Lj$/util/t$c;Z)Lj$/util/stream/e1;
...
.method public longs(JJJ)Ljava/util/stream/LongStream;
    ...
    invoke-static {v0, v1}, Lj$/util/stream/o1;->t(Lj$/util/t$c;Z)Lj$/util/stream/e1;
