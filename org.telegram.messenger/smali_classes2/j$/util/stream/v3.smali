...
.method constructor <init>(Lj$/util/stream/c;Lj$/util/stream/e4;IJJ)V
    ...
    iput-wide p4, p0, Lj$/util/stream/v3;->l:J

    iput-wide p6, p0, Lj$/util/stream/v3;->m:J

    invoke-direct {p0, p1, p2, p3}, Lj$/util/stream/b1;-><init>(Lj$/util/stream/c;Lj$/util/stream/e4;I)V
...
.method E0(Lj$/util/stream/y2;Lj$/util/t;Lj$/util/function/m;)Lj$/util/stream/A1;
    ...
    iget-wide v12, v9, Lj$/util/stream/v3;->l:J

    iget-wide v14, v9, Lj$/util/stream/v3;->m:J
    ...
    invoke-static {v2, v0, v8}, Lj$/util/stream/x2;->h(Lj$/util/stream/y2;Lj$/util/t;Z)Lj$/util/stream/y1;
    ...
    iget-wide v2, v9, Lj$/util/stream/v3;->l:J

    iget-wide v4, v9, Lj$/util/stream/v3;->m:J

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v7}, Lj$/util/stream/v3;->N0(Lj$/util/t$c;JJJ)Lj$/util/t$c;

    move-result-object v0

    invoke-static {v9, v0, v8}, Lj$/util/stream/x2;->h(Lj$/util/stream/y2;Lj$/util/t;Z)Lj$/util/stream/y1;
    ...
    iget-wide v5, v9, Lj$/util/stream/v3;->l:J

    iget-wide v7, v9, Lj$/util/stream/v3;->m:J
...
.method F0(Lj$/util/stream/y2;Lj$/util/t;)Lj$/util/t;
    ...
    check-cast v11, Lj$/util/t$c;

    iget-wide v12, v9, Lj$/util/stream/v3;->l:J

    iget-wide v1, v9, Lj$/util/stream/v3;->m:J
    ...
    invoke-direct/range {v10 .. v15}, Lj$/util/stream/y4;-><init>(Lj$/util/t$c;JJ)V
    ...
    sget-object v4, Lj$/util/stream/t3;->a:Lj$/util/stream/t3;
...
.method H0(ILj$/util/stream/m3;)Lj$/util/stream/m3;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/u3;-><init>(Lj$/util/stream/v3;Lj$/util/stream/m3;)V

    return-object p1
.end method

.method N0(Lj$/util/t$c;JJJ)Lj$/util/t$c;
    .locals 8
    ...
    :goto_1
    new-instance p2, Lj$/util/stream/G4;

    move-object v2, p2

    move-object v3, p1

    invoke-direct/range {v2 .. v7}, Lj$/util/stream/G4;-><init>(Lj$/util/t$c;JJ)V
