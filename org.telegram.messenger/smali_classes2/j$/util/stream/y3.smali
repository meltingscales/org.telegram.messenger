...
.method constructor <init>(Lj$/util/stream/c;Lj$/util/stream/e4;IJJ)V
    ...
    iput-wide p4, p0, Lj$/util/stream/y3;->l:J

    iput-wide p6, p0, Lj$/util/stream/y3;->m:J

    invoke-direct {p0, p1, p2, p3}, Lj$/util/stream/Q;-><init>(Lj$/util/stream/c;Lj$/util/stream/e4;I)V
...
.method E0(Lj$/util/stream/y2;Lj$/util/t;Lj$/util/function/m;)Lj$/util/stream/A1;
    ...
    iget-wide v14, v9, Lj$/util/stream/y3;->m:J
    ...
    invoke-static {v2, v0, v8}, Lj$/util/stream/x2;->f(Lj$/util/stream/y2;Lj$/util/t;Z)Lj$/util/stream/u1;
    ...
    iget-wide v4, v9, Lj$/util/stream/y3;->m:J

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v7}, Lj$/util/stream/y3;->N0(Lj$/util/t$a;JJJ)Lj$/util/t$a;

    move-result-object v0

    invoke-static {v9, v0, v8}, Lj$/util/stream/x2;->f(Lj$/util/stream/y2;Lj$/util/t;Z)Lj$/util/stream/u1;
    ...
    iget-wide v5, v9, Lj$/util/stream/y3;->l:J

    iget-wide v7, v9, Lj$/util/stream/y3;->m:J
...
.method F0(Lj$/util/stream/y2;Lj$/util/t;)Lj$/util/t;
    ...
    check-cast v11, Lj$/util/t$a;

    iget-wide v12, v9, Lj$/util/stream/y3;->l:J

    iget-wide v1, v9, Lj$/util/stream/y3;->m:J
    ...
    invoke-direct/range {v10 .. v15}, Lj$/util/stream/u4;-><init>(Lj$/util/t$a;JJ)V
    ...
    sget-object v4, Lj$/util/stream/w3;->a:Lj$/util/stream/w3;
...
.method H0(ILj$/util/stream/m3;)Lj$/util/stream/m3;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/x3;-><init>(Lj$/util/stream/y3;Lj$/util/stream/m3;)V

    return-object p1
.end method

.method N0(Lj$/util/t$a;JJJ)Lj$/util/t$a;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lj$/util/stream/E4;-><init>(Lj$/util/t$a;JJ)V
