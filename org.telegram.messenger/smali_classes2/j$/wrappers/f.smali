...
.method private synthetic constructor <init>(Lj$/util/r;)V
    ...
    iput-object p1, p0, Lj$/wrappers/f;->a:Lj$/util/r;

    return-void
.end method

.method public static synthetic a(Lj$/util/r;)Ljava/util/PrimitiveIterator$OfLong;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lj$/wrappers/f;-><init>(Lj$/util/r;)V
...
.method public synthetic forEachRemaining(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/r;->d(Lj$/util/function/q;)V
...
.method public synthetic next()Ljava/lang/Long;
    ...
    invoke-interface {v0}, Lj$/util/r;->next()Ljava/lang/Long;
...
.method public synthetic nextLong()J
    ...
    invoke-interface {v0}, Lj$/util/r;->nextLong()J
