...
public final class zzha extends zzfu<zzha> implements Cloneable {
    ...
    public long zzbjf = 0;
    public long zzbjg = 0;
    private String tag = BuildConfig.APP_CENTER_HASH;
    public int zzbji = 0;
    private String zzbjj = BuildConfig.APP_CENTER_HASH;
    ...
    public zzha() {
        ...
        this.zzbjo = null;
        this.zzbjp = bArr;
        this.zzbjq = BuildConfig.APP_CENTER_HASH;
        this.zzbjr = BuildConfig.APP_CENTER_HASH;
        this.zzbjs = null;
        this.zzbjt = BuildConfig.APP_CENTER_HASH;
        this.zzbju = 180000L;
        this.zzbjv = null;
        this.zzbjw = bArr;
        this.zzbjx = BuildConfig.APP_CENTER_HASH;
    ...
    public final void zza(zzfs zzfsVar) throws IOException {
        ...
        if (str3 != null && !str3.equals(BuildConfig.APP_CENTER_HASH)) {
            zzfsVar.zza(13, this.zzbjr);
        }
        String str4 = this.zzbjt;
        if (str4 != null && !str4.equals(BuildConfig.APP_CENTER_HASH)) {
        ...
        if (str5 != null && !str5.equals(BuildConfig.APP_CENTER_HASH)) {
        ...
        if (str6 != null && !str6.equals(BuildConfig.APP_CENTER_HASH)) {
    ...
    public final int zzen() {
        ...
        String str6 = this.zzbjj;
        return (str6 == null || str6.equals(BuildConfig.APP_CENTER_HASH)) ? zzen : zzen + zzfs.zzb(26, this.zzbjj);
    }
