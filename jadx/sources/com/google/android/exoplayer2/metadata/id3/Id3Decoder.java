...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    */
    ...
    private static ImmutableList<String> decodeTextInformationFrameValues(byte[] bArr, int i, int i2) {
        if (i2 >= bArr.length) {
            return ImmutableList.of(BuildConfig.APP_CENTER_HASH);
        }
        ...
        return build.isEmpty() ? ImmutableList.of(BuildConfig.APP_CENTER_HASH) : build;
    }
    ...
    private static String decodeStringIfValid(byte[] bArr, int i, int i2, Charset charset) {
        return (i2 <= i || i2 > bArr.length) ? BuildConfig.APP_CENTER_HASH : new String(bArr, i, i2 - i, charset);
    }
