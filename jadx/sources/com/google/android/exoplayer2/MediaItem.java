...
public final class MediaItem implements Bundleable {
    ...
    public Bundle toBundle() {
        Bundle bundle = new Bundle();
        if (!this.mediaId.equals(BuildConfig.APP_CENTER_HASH)) {
    ...
    public static MediaItem fromBundle(Bundle bundle) {
        ...
        String str = (String) Assertions.checkNotNull(bundle.getString(FIELD_MEDIA_ID, BuildConfig.APP_CENTER_HASH));
