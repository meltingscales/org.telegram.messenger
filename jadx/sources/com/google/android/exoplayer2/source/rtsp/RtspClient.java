...
public final class RtspClient implements Closeable {
    ...
    public final class MessageSender {
        ...
        private RtspRequest getRequestWithCommonHeaders(int i, String str, Map<String, String> map, Uri uri) {
            ...
            builder.addAll(map);
            return new RtspRequest(uri, i, builder.build(), BuildConfig.APP_CENTER_HASH);
        }
            ...
            try {
                ...
                switch (i) {
                    ...
                    case 2:
                        ...
                        return;
                    case 4:
                        onOptionsResponseReceived(new RtspOptionsResponse(i2, RtspMessageUtil.parsePublicHeader(parseResponse.headers.get("Public"))));
                        return;
                    case 5:
