...
public final class TrackGroup implements Bundleable {
    ...
    public TrackGroup(Format... formatArr) {
        this(BuildConfig.APP_CENTER_HASH, formatArr);
    }
    ...
    public static /* synthetic */ TrackGroup lambda$static$0(Bundle bundle) {
        ...
        return new TrackGroup(bundle.getString(FIELD_ID, BuildConfig.APP_CENTER_HASH), (Format[]) fromBundleList.toArray(new Format[0]));
    }
    ...
    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.e("TrackGroup", BuildConfig.APP_CENTER_HASH, new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}
