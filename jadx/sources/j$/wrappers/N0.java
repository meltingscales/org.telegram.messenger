...
public final /* synthetic */ class N0 implements LongStream {
    final /* synthetic */ InterfaceC0084e1 a;

    private /* synthetic */ N0(InterfaceC0084e1 interfaceC0084e1) {
        this.a = interfaceC0084e1;
    }

    public static /* synthetic */ LongStream n0(InterfaceC0084e1 interfaceC0084e1) {
        if (interfaceC0084e1 == null) {
            return null;
        }
        return interfaceC0084e1 instanceof M0 ? ((M0) interfaceC0084e1).a : new N0(interfaceC0084e1);
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ boolean allMatch(LongPredicate longPredicate) {
        return this.a.L(C0221i0.a(longPredicate));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ boolean anyMatch(LongPredicate longPredicate) {
        return this.a.k(C0221i0.a(longPredicate));
    }
    ...
    public /* synthetic */ Object collect(Supplier supplier, ObjLongConsumer objLongConsumer, BiConsumer biConsumer) {
        return this.a.f0(y0.a(supplier), u0.a(objLongConsumer), C0235q.a(biConsumer));
    }
    ...
    public /* synthetic */ LongStream filter(LongPredicate longPredicate) {
        return n0(this.a.u(C0221i0.a(longPredicate)));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ OptionalLong findAny() {
        return AbstractC0046a.t(this.a.findAny());
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ OptionalLong findFirst() {
        return AbstractC0046a.t(this.a.findFirst());
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ LongStream flatMap(LongFunction longFunction) {
        return n0(this.a.s(C0217g0.a(longFunction)));
    }
    ...
    public /* synthetic */ void forEachOrdered(LongConsumer longConsumer) {
        this.a.Z(C0213e0.b(longConsumer));
    }
    ...
    public /* synthetic */ Iterator<Long> iterator2() {
        return C0214f.a(this.a.iterator());
    }
    ...
    public /* synthetic */ LongStream map(LongUnaryOperator longUnaryOperator) {
        return n0(this.a.z(C0233o0.c(longUnaryOperator)));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ DoubleStream mapToDouble(LongToDoubleFunction longToDoubleFunction) {
        return L0.n0(this.a.O(C0225k0.b(longToDoubleFunction)));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ IntStream mapToInt(LongToIntFunction longToIntFunction) {
        return C$r8$wrapper$java$util$stream$IntStream$WRP.convert(this.a.e0(C0229m0.b(longToIntFunction)));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ Stream mapToObj(LongFunction longFunction) {
        return O0.n0(this.a.Q(C0217g0.a(longFunction)));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ OptionalLong max() {
        return AbstractC0046a.t(this.a.max());
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ OptionalLong min() {
        return AbstractC0046a.t(this.a.min());
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ boolean noneMatch(LongPredicate longPredicate) {
        return this.a.S(C0221i0.a(longPredicate));
    }
    ...
    public /* synthetic */ LongStream peek(LongConsumer longConsumer) {
        return n0(this.a.p(C0213e0.b(longConsumer)));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ long reduce(long j, LongBinaryOperator longBinaryOperator) {
        return this.a.D(j, C0209c0.a(longBinaryOperator));
    }

    @Override // java.util.stream.LongStream
    public /* synthetic */ OptionalLong reduce(LongBinaryOperator longBinaryOperator) {
        return AbstractC0046a.t(this.a.g(C0209c0.a(longBinaryOperator)));
    }
    ...
    public /* synthetic */ Spliterator<Long> spliterator() {
        return C0230n.a(this.a.spliterator());
    }
