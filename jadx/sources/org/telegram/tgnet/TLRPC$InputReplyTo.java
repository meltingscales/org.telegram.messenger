...
public abstract class TLRPC$InputReplyTo extends TLObject {
    ...
    public static TLRPC$InputReplyTo TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$InputReplyTo tLRPC$TL_inputReplyToStory = i != 121554949 ? i != 583071445 ? i != 1484862010 ? null : new TLRPC$TL_inputReplyToStory() : new TLRPC$TL_inputReplyToMessage() : new TLRPC$TL_inputReplyToMessage() { // from class: org.telegram.tgnet.TLRPC$TL_inputReplyToMessage_layer166
