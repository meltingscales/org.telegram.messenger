            ...
            case -1813324973:
                tLRPC$UserFull = new TLRPC$UserFull() { // from class: org.telegram.tgnet.TLRPC$TL_userFull_layer159
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        int i7 = this.video_calls_available ? i6 | LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS_NOT_PREMIUM : i6 & (-8193);
                        this.flags = i7;
                        int i8 = this.voice_messages_forbidden ? i7 | FileLoaderPriorityQueue.PRIORITY_VALUE_MAX : i7 & (-1048577);
                        this.flags = i8;
                ...
                break;
            case -1179571092:
                tLRPC$UserFull = new TLRPC$TL_userFull() { // from class: org.telegram.tgnet.TLRPC$TL_userFull_layer175
                    @Override // org.telegram.tgnet.TLRPC$TL_userFull, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
