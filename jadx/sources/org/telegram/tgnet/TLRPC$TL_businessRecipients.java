...
public class TLRPC$TL_businessRecipients extends TLObject {
    ...
    public static TLRPC$TL_businessRecipients TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        if (i != 554733559) {
            if (z) {
        ...
        tLRPC$TL_businessRecipients.readParams(abstractSerializedData, z);
