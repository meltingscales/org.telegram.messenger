...
public abstract class TLRPC$Updates extends TLObject {
    ...
    public static TLRPC$Updates TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1877614335:
                tLRPC$Updates = new TLRPC$Updates() { // from class: org.telegram.tgnet.TLRPC$TL_updateShortSentMessage
                ...
                break;
            case -484987010:
                tLRPC$Updates = new TLRPC$Updates() { // from class: org.telegram.tgnet.TLRPC$TL_updatesTooLong
                };
                break;
            case 826001400:
                tLRPC$Updates = new TLRPC$Updates() { // from class: org.telegram.tgnet.TLRPC$TL_updateShortMessage
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
                ...
                break;
            case 1299050149:
                tLRPC$Updates = new TLRPC$Updates() { // from class: org.telegram.tgnet.TLRPC$TL_updateShortChatMessage
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
                ...
                break;
            case 1918567619:
                tLRPC$Updates = new TLRPC$Updates() { // from class: org.telegram.tgnet.TLRPC$TL_updatesCombined
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
            ...
            case 1957577280:
                ...
                break;
            case 2027216577:
                tLRPC$Updates = new TLRPC$Updates() { // from class: org.telegram.tgnet.TLRPC$TL_updateShort
                    @Override // org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
