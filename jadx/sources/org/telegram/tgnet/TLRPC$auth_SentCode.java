...
public abstract class TLRPC$auth_SentCode extends TLObject {
    ...
    public static TLRPC$auth_SentCode TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == 596704836) {
            tLRPC$auth_SentCode = new TLRPC$auth_SentCode() { // from class: org.telegram.tgnet.TLRPC$TL_auth_sentCodeSuccess
            ...
            tLRPC$auth_SentCode = i != 1577067778 ? null : new TLRPC$auth_SentCode() { // from class: org.telegram.tgnet.TLRPC$TL_auth_sentCode
                @Override // org.telegram.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
