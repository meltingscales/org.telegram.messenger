...
public class TLRPC$TL_stats_publicForwards extends TLObject {
    public int count;
    public int flags;
    public String next_offset;
    public ArrayList<TLRPC$PublicForward> forwards = new ArrayList<>();
    public ArrayList<TLRPC$Chat> chats = new ArrayList<>();
    public ArrayList<TLRPC$User> users = new ArrayList<>();

    public static TLRPC$TL_stats_publicForwards TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        if (-1828487648 != i) {
            if (z) {
        ...
        TLRPC$TL_stats_publicForwards tLRPC$TL_stats_publicForwards = new TLRPC$TL_stats_publicForwards();
        tLRPC$TL_stats_publicForwards.readParams(abstractSerializedData, z);
        return tLRPC$TL_stats_publicForwards;
    }
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        for (int i = 0; i < readInt322; i++) {
            TLRPC$PublicForward TLdeserialize = TLRPC$PublicForward.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
