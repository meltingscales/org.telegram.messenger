...
public abstract class TLRPC$MessageReplyHeader extends TLObject {
    ...
    public static TLRPC$MessageReplyHeader TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1667711039:
                tLRPC$MessageReplyHeader = new TLRPC$TL_messageReplyStoryHeader() { // from class: org.telegram.tgnet.TLRPC$TL_messageReplyStoryHeader_layer174
                ...
                break;
            case -1495959709:
                tLRPC$MessageReplyHeader = new TLRPC$TL_messageReplyHeader() { // from class: org.telegram.tgnet.TLRPC$TL_messageReplyHeader_layer165
            ...
            case 240843065:
                ...
                break;
            case 1029445267:
                tLRPC$MessageReplyHeader = new TLRPC$TL_messageReplyHeader() { // from class: org.telegram.tgnet.TLRPC$TL_messageReplyHeader_layer165_2
                    @Override // org.telegram.tgnet.TLRPC$TL_messageReplyHeader, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
                ...
                break;
            case 1860946621:
                tLRPC$MessageReplyHeader = new TLRPC$TL_messageReplyHeader() { // from class: org.telegram.tgnet.TLRPC$TL_messageReplyHeader_layer166
                    @Override // org.telegram.tgnet.TLRPC$TL_messageReplyHeader, org.telegram.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int readInt32 = abstractSerializedData2.readInt32(z2);
                        this.flags = readInt32;
