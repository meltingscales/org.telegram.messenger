...
public final /* synthetic */ class MessagesController$$ExternalSyntheticBackport3 {
    public static /* synthetic */ long m(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (i4 != 0) {
            ...
            long j = i3;
            long m = MessagesController$$ExternalSyntheticBackport2.m(-1L, j);
            ...
            while (i5 < i2) {
                ...
                if (j3 < j2 || j3 > m || (j3 == m && digit > ((int) MessagesController$$ExternalSyntheticBackport1.m(-1L, j)))) {
