...
public abstract class CacheFetcher<Args, R> {
    ...
    public void fetch(final int i, final Args args, Utilities.Callback<R> callback) {
        ...
        if (cachedResult == null || shouldRequest(pair)) {
            saveCallback(pair, callback);
            getLocal(i, args, new Utilities.Callback2() { // from class: org.telegram.messenger.CacheFetcher$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$fetch$1(final Pair pair, final int i, final Object obj, Long l, final Object obj2) {
        if (shouldRequest(pair)) {
            getRemote(i, obj, l.longValue(), new Utilities.Callback4() { // from class: org.telegram.messenger.CacheFetcher$$ExternalSyntheticLambda2
