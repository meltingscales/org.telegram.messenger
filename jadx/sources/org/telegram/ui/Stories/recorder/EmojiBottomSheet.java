        ...
        public class GifAdapter extends RecyclerListView.SelectionAdapter {
            ...
            public void request() {
                ...
                if (tLRPC$User == null && !this.requestedBot) {
                    ...
                    MessagesStorage.getInstance(((BottomSheet) EmojiBottomSheet.this).currentAccount).getBotCache(str4, new RequestDelegate() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$GifPage$GifAdapter$$ExternalSyntheticLambda6
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
