...
public class ShapeDetector {
    ...
    private ArrayList<Point> resample(ArrayList<Point> arrayList, int i) {
        ...
        while (i4 < arrayList.size()) {
            ...
            if (d5 >= d3) {
                ...
                i2 = i3;
                d = d3;
                Point point = new Point(arrayList.get(i5).x + ((arrayList.get(i4).x - arrayList.get(i5).x) * d6), arrayList.get(i5).y + (d6 * (arrayList.get(i4).y - arrayList.get(i5).y)));
    ...
    private double indicativeAngle(ArrayList<Point> arrayList) {
        ...
        return Math.atan2(centroid.y - arrayList.get(0).y, centroid.x - arrayList.get(0).x);
    }
