    ...
    */
    private void setGiftImage(org.telegram.messenger.MessageObject r14) {
        /*
            ...
            org.telegram.tgnet.TLRPC$TL_messageMediaGiveaway r14 = (org.telegram.tgnet.TLRPC$TL_messageMediaGiveaway) r14
        ...
        L30:
            ...
            if (r7 == 0) goto La3
            int r14 = r14.months
            java.util.Map<java.lang.Integer, java.lang.String> r3 = org.telegram.ui.Components.Premium.boosts.cells.msg.GiveawayMessageCell.monthsToEmoticon
        ...
        L49:
            ...
            boolean r5 = java.util.Objects.equals(r5, r14)
            if (r5 == 0) goto L8e
        ...
        La3:
            if (r2 == 0) goto Lc7
            java.util.ArrayList<org.telegram.tgnet.TLRPC$PhotoSize> r14 = r2.thumbs
            int r0 = org.telegram.ui.ActionBar.Theme.key_emptyListPlaceholder
            r1 = 1045220557(0x3e4ccccd, float:0.2)
            org.telegram.messenger.SvgHelper$SvgDrawable r5 = org.telegram.messenger.DocumentObject.getSvgThumb(r14, r0, r1)
            if (r5 == 0) goto Lb7
            r14 = 512(0x200, float:7.175E-43)
            r5.overrideWidthAndHeight(r14, r14)
        Lb7:
            org.telegram.messenger.ImageReceiver r14 = r13.giftReceiver
        ...
        Ld1:
            r2 = 0
        Ld2:
            r14.loadStickersByEmojiOrName(r0, r1, r2)
        Ld5:
            return
        */
