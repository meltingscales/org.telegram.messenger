    ...
    */
    ...
    private boolean trySetUsername() {
        ...
        if (publicUsername.equals(str2)) {
            ...
            getMessagesController().updateChannelUserName(this, this.chatId, str2, new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
