...
public class ChatbotsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        UniversalRecyclerView universalRecyclerView = new UniversalRecyclerView(context, this.currentAccount, new Utilities.Callback2() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda8
    ...
    public void processDone() {
        ...
        if (!hasChanges()) {
            ...
            getConnectionsManager().sendRequest(tLRPC$TL_account_updateConnectedBot, new RequestDelegate() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda11
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processDone$5(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processDone$4(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setValue$6(TLRPC$TL_account_connectedBots tLRPC$TL_account_connectedBots) {
