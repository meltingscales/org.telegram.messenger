...
public final class BidiFormatter {
    ...
    private String markAfter(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        ...
        if (this.mIsRtlContext || !(isRtl || getExitDir(charSequence) == 1)) {
            return this.mIsRtlContext ? (!isRtl || getExitDir(charSequence) == -1) ? RLM_STRING : BuildConfig.APP_CENTER_HASH : BuildConfig.APP_CENTER_HASH;
        }
        return LRM_STRING;
    }
    ...
    private String markBefore(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        ...
        if (this.mIsRtlContext || !(isRtl || getEntryDir(charSequence) == 1)) {
            return this.mIsRtlContext ? (!isRtl || getEntryDir(charSequence) == -1) ? RLM_STRING : BuildConfig.APP_CENTER_HASH : BuildConfig.APP_CENTER_HASH;
        }
        return LRM_STRING;
    }
